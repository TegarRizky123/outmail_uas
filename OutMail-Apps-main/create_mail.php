<?php
  ...
  $statement = pg_query($connection,"SELECT * FROM surat_keluar;");
...
<body style="background-image: linear-gradient(to bottom left , #000106,#34dee2);">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="sidebar col-md-3 col-sm-3 d-md-block d-sm-block d-none" style="background-image: linear-gradient(to bottom left , #000106,#34dee2); ,height: 660px;">
          <div class="row text-center">
            <div class="col-md-11 mt-3 ">
              <img class="rounded-circle ms-3"src="./simpson.jpg" alt="" width="150px" height="150px"> <br>
              <p class="text-white fw-bold ms-3 fs-3 mt-2">OutMaill App</p>
            </div>
                  ...
                  <li class="active">
                    <div class="my-4">
                      <a href="./create_mail.php" class="text-decoration-none text-white">
                        <h5><i class="bi bi-pencil ms-5 me-3"></i>Create Maill</h5>
                      </a>
                    </div>
                  </li>
                  <li class="passive">
        ...
        <div class="col-md-3 col-sm-3 d-md-none d-sm-none d-block">
           <nav class="navbar tembus navbar-dark bg-info navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom position-fixed" style="background-image: linear-gradient(to bottom left, #6f7bed);">
        ...
        <div class="home col-md-8 col-sm-8 col-12" style="background-image: linear-gradient(to right, #6f7bed);">
          <div class="card mt-5 shadow">
            <div class="card-body">
                <form method="POST" action= "Backend/tambah_proses.php">
                        <div class="card-title ">
                                <h5><b>Create Maill</b></h5>
                                <h6 class="text-muted"></h6>
                                <hr>
                        </div>
                        <div class="form-group mt-2">
                            <p>Number Maill</p>
                            <input type="text" class="form-control" id ="nomor" name ="nomor" placeholder="Masukkan nomor surat . . . ." required>
                        </div>
                        <div class="form-group mt-2">
                            <p for="nama">Date</p>
                        ...
                        <div class="text-center mt-5">
                            <input type="submit" name="submit" class="btn" style="background-color: #2b19b4 color: aliceblue;" value="SAVE" onclick="return confirm('Are you sure ?')">
                        </div>
